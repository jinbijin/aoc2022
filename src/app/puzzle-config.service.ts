...
export class PuzzleConfigService {
  readonly puzzles = [
    ...
    {
      label: 'Day 3: Rucksack Reorganization',
      solver: Puzzle.RucksackReorganization,
    },
    ...
    {
      label: 'Day 7: No Space Left On Device',
      solver: Puzzle.NoSpaceLeftOnDevice,
    },
    ...
    {
      label: 'Day 12: Hill Climbing Algorithm',
      solver: Puzzle.HillClimbingAlgorithm,
    },
    ...
    { label: 'Day 14: Regolith Reservoir', solver: Puzzle.RegolithReservoir },
    {
      ...
      solver: Puzzle.BeaconExclusionZone,
    },
    {
      label: 'Day 16: Proboscidea Volcanium',
      solver: Puzzle.ProboscideaVolcanium,
    },
    ...
    {
      label: 'Day 20: Grove Positioning System',
      solver: Puzzle.GrovePositioningSystem,
    },
